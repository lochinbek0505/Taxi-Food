...
import uz.falconmobile.taxifood.databinding.MenuLayoutBinding
...
class CatAdapter(
    ...
    inner class Holder(var view: MenuLayoutBinding) : RecyclerView.ViewHolder(view.root) {
...
//                this.tvName.text = data.name
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        ...
        val binding =
            MenuLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
